        ...
        <a-tab-pane key="1" type="card">
          ...
          <a-radio-group v-model="result.second.cronEvery">
            ...
            <a-row>
              <a-radio value="4">
                周期从
                <a-input-number class="cron_ipt" size="small" v-model="result.second.rangeStart" :min="1" :max="60"></a-input-number>到
                <a-input-number class="cron_ipt" size="small" v-model="result.second.rangeEnd" :min="0" :max="59"></a-input-number>秒
              </a-radio>
            </a-row>
          </a-radio-group>
        </a-tab-pane>
              ...
              <a-row>
                <a-radio value="4">
                  ...
                  class="cron_ipt"
                    ...
                    :max="60"
                  ></a-input-number>到
                  <a-input-number class="cron_ipt" size="small" v-model="result.minute.rangeEnd" :min="0" :max="59"></a-input-number>分
                </a-radio>
              </a-row>
            </a-radio-group>
          </div>
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.hour.cronEvery">
              ...
              <a-row>
                <a-radio value="4">
                  周期从
                  <a-input-number class="cron_ipt" size="small" v-model="result.hour.rangeStart" :min="0" :max="23"></a-input-number>到
                  <a-input-number class="cron_ipt" size="small" v-model="result.hour.rangeEnd" :min="0" :max="23"></a-input-number>小时
                </a-radio>
              </a-row>
            </a-radio-group>
          </div>
            ...
            <a-radio-group v-model="result.day.cronEvery">
              ...
              <a-row>
                <a-radio value="2">
                  ...
                  <a-select size="small" v-model="result.week.incrementStart" class="cron_ipt">
                    <a-select-option
              ...
              <a-row>
                <a-radio value="8">
                  在这个月的最后一个
                  <a-select class="cron_ipt" size="small" v-model="result.day.cronLastSpecificDomDay">
                    <a-select-option
                      v-for="(val,index) in Array(7)"
                      :key="index"
                      :value="index+1"
          ...
          <div class="tabBody">
            <a-radio-group v-model="result.month.cronEvery">
              ...
              <a-row>
                <a-radio value="4">
                  从
                  <a-input-number class="cron_ipt" size="small" v-model="result.month.rangeStart" :min="1" :max="12"></a-input-number>到
                  <a-input-number class="cron_ipt" size="small" v-model="result.month.rangeEnd" :min="1" :max="12"></a-input-number>月之间的每个月
                </a-radio>
              </a-row>
            </a-radio-group>
          </div>
  ...
  data() {
    return {
      ...
      defaultValue: {
        ...
        year: {
          cronEvery: "",
          incrementStart: currenYear,
          incrementIncrement: 1,
          rangeStart: currenYear,
          rangeEnd: currenYear,
          specificSpecific: []
        },
        label: ""
    ...
    secondsText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          this.result.second.specificSpecific && this.result.second.specificSpecific.map(val => {
            seconds += val + ",";
          });
    ...
    minutesText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          this.result.minute.specificSpecific && this.result.minute.specificSpecific.map(val => {
            minutes += val + ",";
          });
    ...
    hoursText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          this.result.hour.specificSpecific && this.result.hour.specificSpecific.map(val => {
            hours += val + ",";
          });
    ...
    daysText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "3":
          ...
          break;
        case "5":
          this.result.day.specificSpecific && this.result.day.specificSpecific.map(val => {
            days += val + ",";
          });
          days = days.slice(0, -1);
          break;
    ...
    weeksText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "4":
          this.result.week.specificSpecific && this.result.week.specificSpecific.map(val => {
            weeks += val + ",";
          });
    ...
    monthsText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          this.result.month.specificSpecific && this.result.month.specificSpecific.map(val => {
            months += val + ",";
          });
    ...
    yearsText() {
      ...
      switch (cronEvery.toString()) {
        ...
        case "2":
          ...
          break;
        case "3":
          this.result.year.specificSpecific && this.result.year.specificSpecific.map(val => {
            years += val + ",";
          });
